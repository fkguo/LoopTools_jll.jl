...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LoopTools_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e275ce21-2bb6-5a50-939e-e917944b1aed"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LoopTools", artifacts_toml) for e in artifacts["LoopTools"]]
...
if best_platform === nothing
    @debug("Unable to load LoopTools; unsupported platform $(triplet(platform_key_abi()))")
else
